 ...
 * Phase 2 - Experiment 2: 2 VMs, 2 Cloudlets (Workload scales with VMs)
 *
 * Both VMs and cloudlets scaled to 2. Each job gets its own VM.
...
public class CloudSimPhase2Ex2 {
    ...
    public static void main(String[] args) {
        ...
        Log.println("Starting CloudSimPhase2Ex2 - Phase 2: 2 VMs, 2 Cloudlets...");
        ...
        try {
            ...
            Log.println("CloudSimPhase2Ex2 finished!");
